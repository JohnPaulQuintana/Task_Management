            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    ...
                    <div class="flex justify-between mb-6">
                        <div>
                            <div class="text-2xl font-semibold text-primary-600 mb-1">10</div>
                            <div class="text-sm font-medium text-primary-600">Finished Task</div>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-primary-600 ml-4">60%</span>
                    </div>
                ...
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-4">
                        <div>
                            ...
                            <div class="text-sm font-medium text-gray-400">Today Task</div>
                        </div>
                    ...
                    <div class="flex justify-between mb-6">
                        <div>
                            <div class="text-2xl font-semibold mb-1"><span
                                    class="text-base font-bold text-gray-400 align-top"></span>10</div>
                            <div class="text-sm font-medium text-gray-400">Monthly Task</div>
                        </div>
                        <div class="dropdown">
