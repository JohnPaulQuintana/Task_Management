        ...
        <div class="shadow-md sm:rounded-lg border p-5">
            ...
            <div
                ...
                <div class="flex gap-4">
                    ...
                    <div class="mt-2">
                        <i class="fa-solid fa-calendar-circle-plus text-green-500" data-modal-target="crud-modal"
                            id="create-task"></i>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        @foreach ($tasks as $task)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 admin-tr" data-n="{{ $task->task_number }}">
                                <th scope="row"
                                ...
                                <td class="pr-4 py-4 text-right flex">
                                    <a href="#" id="edit-task" data-id="{{ $task->id }}"
                                        data-title="{{ $task->title }}" data-number="{{ $task->task_number }}"
                                    ...
                                    <form action="{{ route('admin.delete', $task->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" id="delete-task"
                                            class="font-medium text-red-600 hover:text-red-400 dark:text-blue-500 hover:underline hover:cursor-pointer">
