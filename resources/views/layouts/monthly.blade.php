<x-app-layout>
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        ...
        <div class="p-5 w-full">
                ...
                <div>
                    <form class="flex items-center max-w-sm mx-auto">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="monthly-search"
            ...
            <div class="p-4 grid lg:grid-cols-4 gap-2 sm:grid-cols-1 md:grid-cols-3" id="monthly-list">
                ...
                @foreach ($tasks as $task)
                    <div
                        ...
                        <div class="content w-full flex px-1 my-4 gap-2 align-middle border-b-2 pb-4">
                            <i
                                class="fa-duotone fa-file-pdf text-7xl border p-3 rounded-lg bg-blue-50 border-blue-50 text-blue-500"></i>
                            <div class="relative w-full">
                                <a href="#" class="w-full absolute">
